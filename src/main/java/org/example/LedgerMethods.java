...
public class LedgerMethods {
    static void displayEntries(ArrayList<Ledger> transactionsList) {
        transactionsList.sort(Comparator.comparing(Ledger::getDate).reversed());
        for (Ledger transactions : transactionsList) {
